...
CharXiv tier2 (4B-13B) (n=1000). Three VLMs as both solver and verifier; every model verifies every
model. Raw data: the `verify_*.json` files in `vlm/result/charxiv_tier2`.
